            ...
            <div>
                <div class="dropdown" v-if="!user.token">
                    <img class="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500"
                        src="../assets/img/avartar1.jpg" alt="Bordered avatar" data-bs-toggle="dropdown" />
                ...
                <div v-if="user.token">
                    <el-dropdown size="large" type="primary">
                        <span class="menu-icon"><img src="../assets/img/logo.png"
                                class="h-8 mr-3 rounded-full" /></span>
                        <template #dropdown>
                            <el-dropdown-menu>
                                <el-dropdown-item>
