...
<template>
    <div class="Book">
        ...
        <div class="container create-btn-container d-flex justify-content-end">
            <el-button class="bg-primary text-white" type="primary" plain @click="handleNavigateToAddBook">Thêm sách
                mới</el-button>
        </div>
        <div class="container table-container">
            <el-table :data="filteredBooks" style="width: 100%">
                ...
                <el-table-column align="right">
                    ...
                    <template #default="scope">
                        <el-button size="small" type="success" @click="navigatorToEdit(scope.row.masach)">Cập
                            nhật</el-button>
