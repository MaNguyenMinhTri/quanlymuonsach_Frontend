...
<template>
    <div class="nxb">
        ...
        <div class="d-flex flex-column my-2" style="width: 300px">
            <label>NXB:</label>
            <el-select class="w-100" v-model="book.manxb" placeholder="Thay đổi NXB" size="large" style="width: 240px">
                <el-option v-for="nxb in nxbs" :key="nxb._id" :label="nxb.TenNxb" :value="nxb._id" />
            </el-select>
        </div>
        <div class="d-flex flex-column my-2">
            <label>Năm sản xuất:</label>
            <el-input v-model="book.namxuatban" type="number" style="width: 300px" size="large"
