        ...
        <div class="shadow-xl flex justify-center items-center flex-col p-8 rounded-md">
            ...
            <div class="grid gap-1">
                ...
                <input type="text"
                    ...
                    placeholder="Số điện thoại" v-model="SoDienThoai" />
                <input type="password"
                ...
                <input type="password"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Mật khẩu xác thực" v-model="rePassword" />
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Họ" v-model="Holot" />
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Tên" v-model="Ten" />
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Ngày sinh" v-model="NgaySinh" />
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Giới tính" v-model="GioiTinh" />
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white mt-3"
                    placeholder="Địa chỉ" v-model="DiaChi" />
                <div class="d-flex flex-column my-2" style="width: 300px">
                    <label for="imageUpload" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tải
                        lên ảnh:</label>
            ...
            <span class="mt-2">Nếu đã có tài khoản?
